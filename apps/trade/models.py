...
class OrderInfo(models.Model):
    ...
    trade_sn = models.CharField(max_length=30, null=True, blank=True, unique=True, verbose_name='交易号')
    pay_status = models.CharField(max_length=30, choices=ORDER_STATUS, default='paying', verbose_name='订单状态')
    post_script = models.CharField(max_length=200, verbose_name='订单留言')
    order_mount = models.DecimalField(default=0, max_digits=12, decimal_places=2, verbose_name='订单金额')
